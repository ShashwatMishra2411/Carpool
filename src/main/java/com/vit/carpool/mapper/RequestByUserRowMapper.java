 ...
 */
public class RequestByUserRowMapper implements RowMapper<RequestByUser> {
     ...
     */
    @Override
    public RequestByUser mapRow(ResultSet rs, int rowNum) throws SQLException {
        // Create a new Request object
        RequestByUser request = new RequestByUser();
